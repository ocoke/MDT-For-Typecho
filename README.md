...
文档：[https://docs.hifun.site/mdt-typecho](https://docs.hifun.site/mdt-typecho/)
...
7. **根据 [文档](https://docs.hifun.site/mdt-typecho)** 配置主题
...
> 非常不推荐使用开发版，因为可能有不确定的不稳定因素，并且不一定有有利改动。<br>如果你使用开发版出现任何问题，欢迎通过 [Issue](https://github.com/oCoke/MDT-For-Typecho/issues) 反馈。

---

### 遇到问题

如果在使用过程中遇到了任何问题，可以先阅读本主题的 [文档](https://docs.hifun.site/mdt-typecho)，并进行一些简单的确认：清理浏览器缓存，更换网络环境，确保 Console 内没有提示访问不到文件等自身原因。
...
- [Highlght.js](https://github.com/highlightjs/highlight.js)
